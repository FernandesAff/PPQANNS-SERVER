...
int main(int argc, char **argv){
	...
	if(argc < 6){
		cout << "Usage: mpirun -n <n_processes> ./ivfpq_test <dataset> <threads_search> <tam> <coarsek> <nsq> <w> <threads_training>" << endl;
		return -1;
	}
	...
	*/
	int nsq, coarsek, threads, w, k, threads_training, comm_sz, provided;
	char* dataset;
	long long tam, tamt;
